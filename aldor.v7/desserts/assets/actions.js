...
const TIME_180=[7.4, 9.05, 9.3,11.2];
const TIME_OPEN_BAG=[11.2,14.5,14.5];
const TIME_BACK_HOME=[105, 109.5];

const ON_SELECT_1=20.4;
const ON_SELECT_2=49.5;
const ON_SELECT_3=79.5;

const SELECT_1=[17.7, ON_SELECT_1];
const SELECT_2=[47, ON_SELECT_2];
const SELECT_3=[76, ON_SELECT_3];

const ON_RETURN_1=42.2;
...
const UNWRAP_3=[ON_UNWWRAP_3, ON_UNWWRAP_2_3, ON_UNWWRAP_3_3, 99.4, ON_SELECT_3];

const DISCOVER_1=[ON_UNWWRAP_1, 42, ON_SELECT_1];
const DISCOVER_2=[ON_UNWWRAP_2, 70.8, ON_SELECT_2];
const DISCOVER_3=[ON_UNWWRAP_3, 99.4, ON_SELECT_3];

const SENSATION_1=[ON_UNWWRAP_1, ON_UNWWRAP_2_1, 50, ON_RETURN_1, ON_SELECT_1];
const SENSATION_2=[ON_UNWWRAP_2, ON_UNWWRAP_2_2, 102, ON_RETURN_2, ON_SELECT_2];
const SENSATION_3=[ON_UNWWRAP_3, ON_UNWWRAP_2_3, 149, ON_RETURN_3, ON_SELECT_3];
...
window.onload = function(){
	...
	setTimeout(function(){ startVideo(); }, 3);
	startItems();
}
